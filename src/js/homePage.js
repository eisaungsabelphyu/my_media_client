...
import { Bootstrap5Pagination } from "laravel-vue-pagination";
    ...
    components: {
        ...
        methods: {
            getAllPost(page = 1) {
                axios.get(`http://localhost:8000/api/post?page=${page}&searchKey=${this.searchKey}&category=${this.searchedCategory}`)
                    .then((response) => {
            ...
            categorySearch(categoryId) {
                this.searchedCategory = categoryId;
                this.getAllPost();
            },
            ...
            // loadPost(page = 1) {
            //     axios.post(`http://localhost:8000/api/category/search?key=${this.searchedCategory}&page=${page}`)
            //         .then((response) => {
